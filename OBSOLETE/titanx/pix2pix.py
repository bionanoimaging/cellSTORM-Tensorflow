            ...
            for step in range(max_steps-opt.batch_size-1):
                ...
                try:
                    ...
                    if should(opt.progress_freq):
                        discrim_loss, gen_loss_GAN, gen_loss_L1, gen_loss_sparse_L1 = sess.run([C2Pmodel.discrim_loss, C2Pmodel.gen_loss_GAN, C2Pmodel.gen_loss_L1, C2Pmodel.gen_loss_sparse_L1, C2Pmodel.gen_loss_TV])
